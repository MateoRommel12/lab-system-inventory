...
// Check if user is logged in and is a faculty member, redirect if not
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($recentMovements as $movement): ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($movement['equipment_name'] ?? 'Unknown Equipment'); ?></td>
                                            <td><?php echo htmlspecialchars($movement['from_location'] ?? 'Not specified'); ?></td>
                                            <td><?php echo htmlspecialchars($movement['to_location'] ?? 'Not specified'); ?></td>
                                            <td><?php echo Helpers::formatDate($movement['movement_date'] ?? date('Y-m-d')); ?></td>
                                            <td><?php echo htmlspecialchars($movement['moved_by'] ?? 'Unknown'); ?></td>
